const apiKey= 'https://api.spoonacular.com/recipes/complexSearch?query=chicken&apiKey=72f848a8582540c3b2ed35188db6b0a7';
function defaultFn() {
...
if(event.target.id === 'closeBtn'){
    ...
    function noRecFn(){
        const rCont = document.getElementById('recipeContainer');
        rCont.innerHTML = '<p>No recipes found</p>';
    }
    function modalFn(recipeId) {
        const mData = document.getElementById('modalContent');
        mData.innerHTML = '';
        fetch(`https://api.spoonacular.com/recipes/complexSearch?query=chicken&apiKey=72f848a8582540c3b2ed35188db6b0a7`);
